<?php class Analisis_indikator_model extends MY_Model
{
	...
	public function list_data($o = 0, $offset = 0, $limit = 500)
	{
		...
		$sql =
			"SELECT u.*,t.tipe AS tipe_indikator,k.kategori AS kategori FROM analisis_indikator u LEFT JOIN analisis_tipe_indikator t ON u.id_tipe = t.id LEFT JOIN analisis_kategori_indikator k ON u.id_kategori = k.id WHERE 1 AND u.desa_id=" . $this->config->item('desa_id');
	...
	public function insert()
	{
		...
		$outp = $this->db->insert('analisis_indikator', $data + ['desa_id' => $this->config->item('desa_id')]);
	...
	{
		$sql =
			"SELECT * FROM analisis_parameter WHERE id_indikator = ? AND desa_id=" . $this->config->item('desa_id');
