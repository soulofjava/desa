...
class keuangan_grafik_manual_model extends CI_model
{
	...
	public function rp_apbd_widget($thn, $opt = false)
	{
		...
		$data['jenis_pelaksanaan'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_ref_rek1')->result_array();

		$this->db->select('LEFT(Kd_Rincian, 2) AS jenis_pelaksanaan, SUM(Nilai_Anggaran) AS pagu');
		$this->db->where('Tahun', $thn);
		$this->db->group_by('jenis_pelaksanaan');
		$data['anggaran'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_rinci')->result_array();

		$this->db->select('LEFT(Kd_Rincian, 2) AS jenis_pelaksanaan, SUM(Nilai_Realisasi) AS realisasi');
		$this->db->group_by('jenis_pelaksanaan');
		$this->db->where('Tahun', $thn);
		$data['realisasi_pendapatan'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_rinci')->result_array();

		$this->db->select('LEFT(Kd_Rincian, 2) AS jenis_pelaksanaan, SUM(Nilai_Realisasi) AS realisasi');
		$this->db->where('keuangan_manual_rinci.Tahun', $thn);
		$this->db->group_by('jenis_pelaksanaan');
		$this->db->like('Kd_Rincian', '5.', 'after');
		$data['realisasi_belanja'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_rinci')->result_array();
	...
	public function r_pd_widget($thn, $opt = false)
	{
		...
		$data['jenis_pendapatan'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_ref_rek3')->result_array();
	...
	public function r_bd_widget($thn, $opt = false)
	{
		...
		$data['jenis_belanja'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_ref_bidang')->result_array();
  ...
  */
	...
	public function lap_rp_apbd($thn)
	{
		...
		$data['pendapatan'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_ref_rek1')->result_array();
		...
		$data['belanja'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_ref_rek1')->result_array();
		...
		$data['belanja_bidang'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_ref_bidang')->result_array();
		...
		$data['pembiayaan'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_ref_rek1')->result_array();
		...
		$data['pembiayaan_keluar'] = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_ref_rek1')->result_array();
	...
	private function pagu_akun($akun, $thn)
	{
		...
		$this->db->where('Tahun', $thn);
		$this->db->group_by('Akun');
		return $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_rinci')->result_array();
	}
	...
	private function get_subval_pendapatan($akun, $thn = false)
	{
		...
		$data = $this->db->where('desa_id', $this->config->item('desa_id'))->get('keuangan_manual_ref_rek2')->result_array();
		foreach ($data as $i => $d) {
